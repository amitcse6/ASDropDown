...
extension ASDropDownView {
    ...
    public func setDefaultShadow() -> ASDropDownView {
        container?.asdShadowDefault(UIColor(asdRed: "#ffffff", alpha: 1.0), UIColor(red: 200.0/255.0, green: 200.0/255.0, blue: 200.0/255.0, alpha: 1.0), UIColor(asdRed: "#AAAAAA", alpha: 1.0), 5, scale: true)
        return self
    }
...
//    }
    ...
    convenience init(asdRed: String, alpha: CGFloat = 1.0) {
        let hexString: String = asdRed.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines)
